...
public class BlackstoneToolsMod implements ModInitializer {
 ...
 public void onInitialize() {
 	...
 	if(FabricLoader.getInstance().isModLoaded("lvmnt"))
 		Registry.register(Registry.ITEM, new Identifier(MOD_ID, "blackstone_superaxe"), new SuperAxeItem(new SuperAxesMaterialGenerator(BlackstoneToolMaterial.BLACKSTONE), new Item.Settings().group(SuperAxesMod.SUPERAXES_GROUP)));
